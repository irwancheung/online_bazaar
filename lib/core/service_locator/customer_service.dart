...
Future<void> initCustomerService() async {
  ...
  sl.registerFactory(() => CustomerSettingCubit(repository: sl()));
  ...
  sl.registerLazySingleton<CustomerSettingRepository>(
    () => CustomerSettingRepositoryImpl(dataSource: sl()),
  );

  //! Data Source
  sl.registerLazySingleton(() => CustomerMenuDataSource(firestore: sl()));
  sl.registerLazySingleton(() => CustomerCartDataSource(firestore: sl()));
  sl.registerLazySingleton(() => CustomerSettingDataSource(firestore: sl()));
}
